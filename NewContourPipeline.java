package org.firstinspires.ftc.teamcode.techserpents.Autonomous;
...
public class NewContourPipeline extends OpenCvPipeline {
    ...
    public NewContourPipeline(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
